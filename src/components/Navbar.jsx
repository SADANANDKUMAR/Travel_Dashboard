...
export default function Navbar() {
  ...
  return (
    <nav className="nh-nav shadow-sm border-b bg-white">
      <div className="nh-nav-inner flex items-center justify-between">
    
        {/* LEFT */}
        <div className="nh-left flex items-center gap-3">
       <img
            src="/logo-cuise.jpg"
            alt="Logo"
          ...
          />
          {/* Desktop Search */}
          <div className="nh-search-desktop flex items-center bg-gray-100 rounded-lg px-3 py-2 gap-2">
        ...
        {/* RIGHT */}
        <div className="nh-right flex items-center gap-3">

          {/* Notification */}
          <button className="nh-btn relative">
            <FaBell className="nh-icon" />
            <span className="nh-badge">20</span>
          </button>
